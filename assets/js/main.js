...
// jQuery here
      ...
      $('.info').click(function() {
          $('.infopopup').addClass('showme');
          $('.info').addClass('hideme');
          $('.project-container').addClass('hideme');
          $('.close').addClass('showme');

          $('.menuitem').addClass('changecolor');
      });

      $('.close').click(function() {
          $('.infopopup').removeClass('showme');
          $('.info').removeClass('hideme');
          $('.project-container').removeClass('hideme');
